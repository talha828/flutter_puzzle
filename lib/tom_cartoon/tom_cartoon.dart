...
class TomCartoon extends StatefulWidget {
  @override
  State<TomCartoon> createState() => _TomCartoonState();
}

class _TomCartoonState extends State<TomCartoon> {
  List<ImageModel> list = [
    ImageModel(image: "assets/tom/crop/1.png", index: 1),
    ImageModel(image: "assets/tom/crop/2.png", index: 2),
    ImageModel(image: "assets/tom/crop/3.png", index: 3),
    ImageModel(image: "assets/tom/crop/4.png", index: 4),
    ImageModel(image: "assets/tom/crop/5.png", index: 5),
    ImageModel(image: "assets/tom/crop/6.png", index: 6),
    ImageModel(image: "assets/tom/crop/7.png", index: 7),
    ImageModel(image: "assets/tom/crop/8.png", index: 8),
    ImageModel(image: "assets/tom/crop/9.png", index: 9),
    ImageModel(image: "assets/tom/crop/10.png", index: 10),
    ImageModel(image: "assets/tom/crop/11.png", index: 11),
    ImageModel(image: "assets/tom/crop/12.png", index: 12),
  ];
